                ...
                <div className="mb-6">
                    <div className="flex items-center justify-between mb-3">
                        <a
                            ...
                            className="inline-flex items-center px-4 py-2 rounded-md text-sm font-medium bg-accent text-white hover:bg-accent-dark transition-colors"
                        >
                            Download PDF
                        </a>
                    </div>
                    <object
                        ...
                        className="w-full h-[80vh] rounded-lg border border-neutral-200 dark:border-neutral-800"
                    >
