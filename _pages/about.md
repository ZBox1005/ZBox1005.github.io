...
My current research centers on developing **trustworthy** agentic and generative AI systems, especially *Agentic LLMs* and *Diffusion Models*, with a focus on *<font color=red>safety</font>*, *<font color=darkyellow>reliability</font>*, and *<font color=blue>robustness</font>*. I am also working on reliable detection for AI-generated visual content (e.g., images and videos), and interdisciplinary applications of machine learning methods in healthcare (e.g., Immunology, Cell Morphology).
